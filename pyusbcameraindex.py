...
From https://github.com/JohnHardy/pyusbcameraindex
"""
...
USBCameraDevice = namedtuple('CameraDevice', 'name vid pid index path size device lock')
...
def enumerate_usb_video_devices_windows():
    ...
    while count > 0:
        ...
        camera = USBCameraDevice(name=name, vid=vid, pid=pid, index=index, path=path, size=None, device=None, lock=None)
